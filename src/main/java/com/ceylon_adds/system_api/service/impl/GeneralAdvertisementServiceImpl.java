...
public class GeneralAdvertisementServiceImpl implements GeneralAdvertisementService {
    ...
    public void create(GeneralAdvertisementRequestDTO dto) {
        ...
        GeneralAdvertisement ad = GeneralAdvertisement.builder()
                ...
                .telegramNumber(dto.getTelegramNumber())
                .viber(dto.getViber())
                .viberNumber(dto.getViberNumber())
                .imo(dto.getImo())
...
//  Map request to GeneralAdvertisement
    ...
    private GeneralAdvertisementResponseDTO mapToResponseDTO(GeneralAdvertisement ad) {
        ...
        return GeneralAdvertisementResponseDTO.builder()
                ...
                .telegramNumber(ad.getTelegramNumber())
                .imo(ad.getImo())
                .imoNumber(ad.getImoNumber())
                .viber(ad.getViber())
                .viberNumber(ad.getViberNumber())
                .isFake(ad.getIsFake())
