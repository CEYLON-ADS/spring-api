...
public class FileDataHandler {
    ...
    public String extractActualFileName(InputStreamReader data) {
        ...
        try (BufferedReader bufReader = new BufferedReader(data)) {
            ...
            throw new InternalServerErrorException(String.format("Error while reading file name : %s", exception.getMessage()));
        }
    ...
    public byte[] blobToByteArray(Blob blob){
        ...
        try (InputStream inputStream = blob.getBinaryStream();
            ...
            throw new InternalServerErrorException(String.format("Error while converting blob to byte array : %s", exception.getMessage()));
        }
    }
    ...
    public String blobToString(Blob blob) {
        ...
        try (BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(blob.getBinaryStream(), StandardCharsets.UTF_8))) {
            ...
            throw new InternalServerErrorException(String.format("Error while converting blob to string : %s", exception.getMessage()));
        }
